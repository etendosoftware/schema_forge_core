...
describe('Handlebars templates', () => {
  it('EventHandler.java.hbs compiles and generates valid Java', async () => {
    ...
    const result = template({
      ...
      derivations: [
        { field: 'organization', column: 'AD_Org_ID',
    ...
    // Template now generates TODO stubs for derivations
    assert.ok(result.includes('Derivation: organization'));
  ...
  it('RxEndpoint.java.hbs generates endpoint', async () => {
    ...
    // RT-5: org-level filter via OBContext in create method
