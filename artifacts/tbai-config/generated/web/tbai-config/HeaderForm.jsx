...
const fields = [
  ...
  { key: 'tbaisystemdate', column: 'Tbaisystemdate', type: 'date', label: 'Fecha Acogida TBAI', required: true, section: 'principal', defaultValue: '@#Date@' },
  ...
  { key: 'uSEAsproductDesc', column: 'USE_Asproduct_Desc', type: 'checkbox', label: 'Utilizar descripción también para nombre producto', required: true, section: 'principal', defaultValue: 'N' },
  { key: 'autoSendInvoices', column: 'Auto_Send_Invoices', type: 'checkbox', label: 'Auto enviar facturas al completarse', required: true, section: 'other', defaultValue: 'N' },
  { key: 'jasperreportPath', column: 'Jasperreport_Path', type: 'text', label: 'Ruta de Reporte Jasper', section: 'other' },
  { key: 'validatePreviousInvoice', column: 'Validate_Previous_Invoice', type: 'checkbox', label: 'Validar factura anterior', required: true, section: 'other', defaultValue: 'N' },
];
