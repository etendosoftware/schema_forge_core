...
const fields = [
  ...
  { key: 'transactionDocument', column: 'C_DocTypeTarget_ID', type: 'search', label: 'Transaction Document', required: true, section: 'principal', reference: 'DocumentType', inputMode: 'search', readOnlyLogic: (record) => record.processed === true },
  ...
  { key: 'businessPartner', column: 'C_BPartner_ID', type: 'search', label: 'Business Partner', required: true, section: 'principal', reference: 'BusinessPartner', inputMode: 'search', visible: null, visibilitySource: 'server', displayLogicReason: 'server-macro', readOnlyLogic: (record) => record.processed === true },
  ...
  // @sf-custom-slot callout:SL_Order_UpdateLinesDate
  { key: 'scheduledDeliveryDate', column: 'DatePromised', type: 'date', label: 'Scheduled Delivery Date', required: true, section: 'other', readOnlyLogic: (record) => record.processed === true },
  ...
  { key: 'priceList', column: 'M_PriceList_ID', type: 'selector', label: 'Price List', required: true, section: 'other', reference: 'PriceList', inputMode: 'selector', readOnlyLogic: (record) => record.processed === true },
  ...
  { key: 'deliveryNotes', column: 'Deliverynotes', type: 'textarea', label: 'Delivery notes', section: 'other', readOnlyLogic: (record) => record.processed === true },
  ...
  { key: 'orderReference', column: 'POReference', type: 'text', label: 'Order Reference', section: 'other', readOnlyLogic: (record) => record.processed === true },
  { key: 'invoiceAddress', column: 'BillTo_ID', type: 'dependent', label: 'Invoice From', required: true, section: 'other', reference: 'BusinessPartnerLocation', inputMode: 'dependent', dependsOn: { field: 'businessPartner', filterKey: 'C_BPartner_ID' }, readOnlyLogic: (record) => record.processed === true },
