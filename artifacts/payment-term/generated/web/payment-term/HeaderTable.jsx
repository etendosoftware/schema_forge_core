...
const columns = [
  ...
  { key: 'default', column: 'IsDefault', type: 'boolean', labels: {"es_ES":"Por defecto","en_US":"Default"}, label: 'Default', badge: true, badgeLabels: {"true":{"es_ES":"Sí","en_US":"Yes"},"false":{"es_ES":"No","en_US":"No"}}, badgeColors: {"true":"bg-blue-100 text-blue-800","false":"bg-gray-100 text-gray-500"} },
];
