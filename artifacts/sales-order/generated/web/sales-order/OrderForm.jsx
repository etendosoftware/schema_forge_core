...
const fields = [
  { key: 'documentNo', column: 'DocumentNo', type: 'text', readOnly: true, section: 'principal' },
  ...
  { key: 'documentStatus', column: 'DocStatus', type: 'text', required: true, readOnly: true, section: 'summary' },
