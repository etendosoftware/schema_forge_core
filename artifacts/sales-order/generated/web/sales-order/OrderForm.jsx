...
const fields = [
  ...
  { key: 'orderDate', column: 'DateOrdered', type: 'date', label: 'Order Date', required: true, section: 'principal' },
  ...
  // @sf-custom-slot callout:SL_Order_UpdateLinesDate
  { key: 'scheduledDeliveryDate', column: 'DatePromised', type: 'date', label: 'Scheduled Delivery Date', required: true, section: 'other' },
  ...
  { key: 'warehouse', column: 'M_Warehouse_ID', type: 'search', label: 'Warehouse', required: true, section: 'other', reference: 'Warehouse', inputMode: 'search' },
  { key: 'invoiceTerms', column: 'InvoiceRule', type: 'text', label: 'Invoice Terms', required: true, section: 'other' },
  ...
  { key: 'salesRepresentative', column: 'SalesRep_ID', type: 'search', label: 'Sales Representative', section: 'other', reference: 'SalesRepresentative', inputMode: 'search' },
  { key: 'description', column: 'Description', type: 'textarea', label: 'Description', section: 'other' },
  { key: 'invoiceAddress', column: 'BillTo_ID', type: 'dependent', label: 'Invoice Address', required: true, section: 'other', reference: 'BusinessPartnerLocation', inputMode: 'dependent', dependsOn: { field: 'businessPartner', filterKey: 'C_BPartner_ID' } },
  { key: 'deliveryLocation', column: 'Delivery_Location_ID', type: 'dependent', label: 'Delivery Location', section: 'other', reference: 'BusinessPartnerLocation', inputMode: 'dependent', dependsOn: { field: 'businessPartner', filterKey: 'C_BPartner_ID' } },
  { key: 'quotation', column: 'Quotation_ID', type: 'search', label: 'Quotation', readOnly: true, section: 'other', reference: 'Order', inputMode: 'search' },
  { key: 'deliveryStatus', column: 'DeliveryStatus', type: 'number', label: 'Delivery Status', readOnly: true, section: 'other' },
  { key: 'invoiceStatus', column: 'InvoiceStatus', type: 'number', label: 'Invoice Status', readOnly: true, section: 'other' },
  { key: 'cancelledorder', column: 'Cancelledorder_id', type: 'search', label: 'Canceled Order', readOnly: true, section: 'other', reference: 'Order', inputMode: 'search' },
  { key: 'replacedorder', column: 'Replacedorder_id', type: 'search', label: 'Replaced Order', readOnly: true, section: 'other', reference: 'Order', inputMode: 'search' },
  { key: 'isCanceled', column: 'Iscancelled', type: 'checkbox', label: 'Is Canceled', required: true, readOnly: true, section: 'other' },
  ...
  { key: 'project', column: 'C_Project_ID', type: 'dependent', label: 'Project', section: 'other', reference: 'Project', inputMode: 'dependent', dependsOn: { field: 'businessPartner', filterKey: 'C_BPartner_ID' } },
  ...
  { key: 'cancelAndReplace', column: 'Cancelandreplace', type: 'text', label: 'Cancel and Replace', section: 'other' },
  { key: 'confirmCancelAndReplace', column: 'Confirmcancelandreplace', type: 'text', label: 'Confirm Cancel and Replace', section: 'other' },
