...
const fields = [
  ...
  { key: 'customerBlocking', column: 'Customer_Blocking', type: 'checkbox', label: 'On Hold', required: true, section: 'other', defaultValue: 'N' },
  ...
  { key: 'paymentIn', column: 'SO_Payment_Blocking', type: 'checkbox', label: 'Payment In', required: true, section: 'other', defaultValue: 'N' },
