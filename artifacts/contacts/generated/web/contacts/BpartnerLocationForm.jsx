...
const fields = [
  ...
  { key: 'shipToAddress', column: 'IsShipTo', type: 'checkbox', required: true, section: 'principal' },
  { key: 'invoiceToAddress', column: 'IsBillTo', type: 'checkbox', required: true, section: 'other' },
  { key: 'active', column: 'IsActive', type: 'checkbox', required: true, readOnly: true, section: 'other' },
  // @sf-custom-slot callout:SL_BPartnerLocation
  { key: 'taxLocation', column: 'IsTaxLocation', type: 'checkbox', required: true, section: 'other' },
];
