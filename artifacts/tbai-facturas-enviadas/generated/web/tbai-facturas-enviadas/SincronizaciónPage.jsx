...
import SincronizaciónTable from './SincronizaciónTable';
import SincronizaciónForm from './SincronizaciónForm';
import ResultadoValidaciónTable from './ResultadoValidaciónTable';
import ResultadoValidaciónForm from './ResultadoValidaciónForm';
...
// @sf-generated-start component:SincronizaciónPage
export default function SincronizaciónPage({ windowName, recordId, ...props }) {
  if (recordId) {
    return (
      <DetailView
        entity="sincronización"
        detailEntity="resultadoValidación"
        Form={SincronizaciónForm}
        DetailTable={ResultadoValidaciónTable}
        DetailForm={ResultadoValidaciónForm}
        summary={summary}
...
// @sf-generated-end component:SincronizaciónPage
