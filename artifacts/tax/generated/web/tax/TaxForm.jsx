...
const fields = [
  ...
  { key: 'applicableTo', column: 'SOPOType', type: 'select', label: 'Sales/Purchase Type', required: true, section: 'principal', options: [{ value: 'B', label: 'Both' }, { value: 'P', label: 'Purchase Tax' }, { value: 'S', label: 'Sales Tax' }], defaultValue: 'B' },
