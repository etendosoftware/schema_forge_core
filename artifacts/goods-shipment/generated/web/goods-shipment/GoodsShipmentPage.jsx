...
// @sf-generated-start statusBar:goodsShipment
function GoodsShipmentStatusBar({ data }) {
  const ui = useUI();
  if (!data) return null;
...
// @sf-generated-end statusBar:goodsShipment
  ...
  if (recordId) {
    return (
      ...
      api={api}
        ...
        headerContent={(data) => <GoodsShipmentStatusBar data={data} />}
        salesTheme
