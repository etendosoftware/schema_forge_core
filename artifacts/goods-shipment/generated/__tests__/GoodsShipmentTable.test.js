...
const tableSrc = readFileSync(
  join(__dirname, '..', 'web', 'goods-shipment', 'GoodsShipmentTable.jsx'),
  'utf8'
);

const pageSrc = readFileSync(
  join(__dirname, '..', 'web', 'goods-shipment', 'GoodsShipmentPage.jsx'),
  'utf8'
);
...
describe('Goods Shipment GoodsShipmentTable — posted badge column', () => {
...
describe('Goods Shipment GoodsShipmentPage — post and unpost menuActions', () => {
