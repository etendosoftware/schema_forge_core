...
// @sf-generated-start fields:Documentos
const fields = [
  ...
  { key: 'allowNegative', column: 'AllowNegative', type: 'checkbox', label: 'Allow negative', required: true, readOnly: true, section: 'other' },
  { key: 'aDCreatefactTemplateID', column: 'AD_Createfact_Template_ID', type: 'selector', label: 'Accounting Template', readOnly: true, section: 'other', reference: 'Createfact_Template', inputMode: 'selector' },
];
// @sf-generated-end fields:Documentos

// @sf-generated-start component:DocumentosForm
export default function DocumentosForm(props) {
  return <EntityForm fields={fields} {...props} />;
}

// @sf-generated-end component:DocumentosForm
