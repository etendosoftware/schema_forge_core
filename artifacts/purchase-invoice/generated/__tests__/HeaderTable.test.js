...
const tableSrc = readFileSync(
  join(__dirname, '..', 'web', 'purchase-invoice', 'HeaderTable.jsx'),
  'utf8'
);

const pageSrc = readFileSync(
  join(__dirname, '..', 'web', 'purchase-invoice', 'HeaderPage.jsx'),
  'utf8'
);
...
describe('Purchase Invoice HeaderTable — posted badge column', () => {
...
describe('Purchase Invoice HeaderPage — post menuAction', () => {
  ...
  it('declares a reactivate action as the unpost equivalent', () => {
    assert.match(pageSrc, /key:\s*'reactivate'/);
  });
});
