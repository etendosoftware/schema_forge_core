...
const fields = [
  ...
  { key: 'financialInvoiceLine', column: 'Financial_Invoice_Line', type: 'checkbox', label: 'Financial Invoice Line', required: true, section: 'principal' },
  // @sf-custom-slot callout:SL_Invoice_Product
  { key: 'product', column: 'M_Product_ID', type: 'selector', label: 'Product', section: 'principal', reference: 'Product', inputMode: 'selector' },
  // @sf-custom-slot callout:SL_Invoice_Glitem
  { key: 'account', column: 'Account_ID', type: 'search', label: 'Account', section: 'principal', reference: 'Glitem', inputMode: 'search' },
  // @sf-custom-slot callout:OperativeQuantity_To_BaseQuantity
  { key: 'operativeQuantity', column: 'Aumqty', type: 'text', label: 'Operative Quantity', section: 'other' },
  // @sf-custom-slot callout:OperativeQuantity_To_BaseQuantity
  ...
  // @sf-custom-slot callout:SL_Invoice_Amt
  { key: 'tax', column: 'C_Tax_ID', type: 'search', label: 'Tax', section: 'other', reference: 'Tax', inputMode: 'search' },
  ...
  { key: 'goodsShipmentLine', column: 'M_InOutLine_ID', type: 'search', label: 'Goods Receipt Line', readOnly: true, section: 'other', reference: 'InOutLine', inputMode: 'search' },
  { key: 'deferred', column: 'IsDeferred', type: 'checkbox', label: 'Deferred Expense', required: true, section: 'other' },
  ...
  { key: 'deferredPlanType', column: 'DefPlanType', type: 'text', label: 'Expense Plan Type', section: 'other' },
  { key: 'periodNumber', column: 'Periodnumber', type: 'number', label: 'Period Number', section: 'other' },
  { key: 'period', column: 'C_Period_ID', type: 'search', label: 'Period', section: 'other', reference: 'Period', inputMode: 'search' },
  ...
  { key: 'matchLCCosts', column: 'Match_Lccosts', type: 'text', label: 'Match LC Costs', section: 'other' },
];
