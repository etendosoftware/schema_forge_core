...
const fields = [
  ...
  { key: 'validUntil', column: 'validuntil', type: 'date', section: 'other' },
  ...
  { key: 'rejectReason', column: 'C_Reject_Reason_ID', type: 'selector', section: 'other', reference: 'Reject_Reason', inputMode: 'selector' },
  ...
  { key: 'currency', column: 'C_Currency_ID', type: 'search', required: true, readOnly: true, section: 'other' },
  ...
  { key: 'createOrder', column: 'Convertquotation', type: 'text', section: 'other' },
