...
const fields = [
  ...
  { key: 'rejectReason', column: 'C_Reject_Reason_ID', type: 'selector', label: 'Reject Reason', section: 'principal', reference: 'Reject_Reason', inputMode: 'selector', displayLogic: (record) => record.documentStatus === 'CJ', readOnlyLogic: (record) => record['documentStatus'] === 'CJ' || record['documentStatus'] === 'CA' },
