...
function AssetsStatusBar({ data }) {
  ...
  const fullyDep = data.fullyDepreciated === true || data.fullyDepreciated === 'Y';
...
const processes = [
  { name: 'processAsset', label: 'Create Amortization', columnName: 'processAsset', displayLogicRaw: "@Depreciate@ = 'Y'" },
];
