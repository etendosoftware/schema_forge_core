...
const columns = [
  ...
  { key: 'periodStatus', column: 'PeriodStatus', type: 'enum', label: 'Period Status', enumLabels: { 'C': 'Closed', 'N': 'Never opened', 'O': 'Open', 'P': 'Permanently closed' }, badge: true, badgeVariants: {"O":"green","N":"neutral","C":"red","P":"red"} },
];
