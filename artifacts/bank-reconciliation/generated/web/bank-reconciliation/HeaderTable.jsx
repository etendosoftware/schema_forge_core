...
const columns = [
  ...
  { key: 'transactionDate', column: 'TransactionDate', type: 'date', label: 'Transaction Date', required: true },
  { key: 'endingBalance', column: 'EndingBalance', type: 'amount', label: 'Ending Balance' },
