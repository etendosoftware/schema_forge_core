...
const tableSrc = readFileSync(
  join(__dirname, '..', 'web', 'sales-invoice', 'HeaderTable.jsx'),
  'utf8'
);

const pageSrc = readFileSync(
  join(__dirname, '..', 'web', 'sales-invoice', 'HeaderPage.jsx'),
  'utf8'
);
...
describe('Sales Invoice HeaderTable — posted badge column', () => {
...
describe('Sales Invoice HeaderPage — post menuAction', () => {
