...
const fields = [
  ...
  { key: 'createLinesFromShipment', column: 'Createfrominouts', type: 'text', label: 'Create Lines From Shipment', section: 'other' },
  ...
  { key: 'calculatePromotions', column: 'Calculate_Promotions', type: 'text', label: 'Calculate Promotions', section: 'other' },
  ...
  { key: 'paidAmountAtInvoicing', column: 'Paidamtatinvoicing', type: 'number', label: 'Paid Amount at Invoicing', readOnly: true, section: 'other' },
  { key: 'withholdingamount', column: 'Withholdingamount', type: 'number', label: 'Withholdingamount', section: 'other', visible: null, visibilitySource: 'server', displayLogicReason: 'session-variable' },
];
