...
const fields = [
  ...
  { key: 'oBCVATMANUALSETTLEMENTLINE', column: 'EM_OBCVAT_MANUALSETTLEMENTLINE_ID', type: 'selector', label: 'Manual Cash VAT Settlement Line', readOnly: true, section: 'other', reference: 'OBCVAT_ManualSettlementLine', inputMode: 'selector' },
