...
const fields = [
  ...
  { key: 'depreciationType', column: 'Amortizationtype', type: 'select', label: 'Depreciation Type', required: true, section: 'principal', options: [{ value: 'LI', label: 'Linear' }], displayLogic: (record) => record.depreciate === true || record.depreciate === 'Y' },
  { key: 'calculateType', column: 'Amortizationcalctype', type: 'select', label: 'Calculate Type', required: true, section: 'principal', options: [{ value: 'PE', label: 'Percentage' }, { value: 'TI', label: 'Time' }], displayLogic: (record) => record.depreciate === true || record.depreciate === 'Y' },
  ...
  { key: 'amortize', column: 'Assetschedule', type: 'select', label: 'Amortize', required: true, section: 'principal', options: [{ value: 'MO', label: 'Monthly' }, { value: 'YE', label: 'Yearly' }], displayLogic: (record) => (record.depreciate === true || record.depreciate === 'Y') && record.calculateType === 'TI' },
