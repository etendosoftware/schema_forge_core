...
const fields = [
  ...
  { key: 'pSD2StatementFrequency', column: 'EM_PSD2_Statement_Frequency', type: 'select', label: 'Statement Frequency', section: 'other', options: [{ value: '1BE', label: 'One per run' }, { value: '1BD', label: 'One per day' }, { value: '1BW', label: 'One per week' }, { value: '1BM', label: 'One per month' }], defaultValue: '1BE' },
  ...
  { key: 'pSD2ConnectionStatus', column: 'EM_PSD2_Connection_Status', type: 'select', label: 'Connection Status', readOnly: true, section: 'other', options: [{ value: 'CO', label: 'Connected' }, { value: 'DC', label: 'Disconnected' }], defaultValue: '\'DC\'' },
];
