...
export function DataProvider({
  ...
  const { token, clientId, selectedRole, selectedOrg, authRevision, isSessionReady, captureSession, isCurrentSession } = useAuth();
  ...
  const scope = useMemo(
    ...
    [token, clientId, selectedRole, selectedOrg, authRevision],
  );
