  ...
  const lineTooltipEl = tooltip && (() => {
    ...
    return (
      <g pointerEvents="none">
        ...
        <circle cx={revPts[idx].x} cy={revPts[idx].y} r="8" fill="#FFFFFF" stroke="#121217" strokeWidth="1.5" />
        {hasExpenses && expPts[idx] && (
          <circle cx={expPts[idx].x} cy={expPts[idx].y} r="8" fill="#FFFFFF" stroke="#121217" strokeWidth="1.5" />
        )}
