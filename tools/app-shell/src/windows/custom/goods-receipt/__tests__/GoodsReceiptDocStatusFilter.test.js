...
describe('GoodsReceiptWindow — DocStatus URL filter (ETP-4004)', () => {
  ...
  it('exports a default function component named GoodsReceiptWindow', () => {
    assert.match(src, /export default function GoodsReceiptWindow/,
      'must export GoodsReceiptWindow as the default export');
  });
});
