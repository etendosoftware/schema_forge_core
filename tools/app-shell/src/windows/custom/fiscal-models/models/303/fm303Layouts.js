...
const BASE = {
  ...
  sections: {
    iva_devengado: {
      ...
      rows: [
        { id: '150',             cells: [150, 151, 152] },
        { id: '165',             cells: [165, 166, 167] },
        { id: 'regimen_general', labelKey: 'fm.box.row.regimen_general',  cells: [1,    2,    3   ] },
        ...
        { id: '156',             cells: [156, 157, 158] },
        { id: '168',             cells: [168, 169, 170] },
        { id: 'recargo_equiv',   labelKey: 'fm.box.row.recargo_equiv',    cells: [16,   17,   18  ] },
        { id: '19',              cells: [19,  20,  21 ] },
        { id: '22',              cells: [22,  23,  24 ] },
        { id: 'mod_recargo',     labelKey: 'fm.box.row.mod_recargo',      cells: [25,   null, 26  ] },
        { id: 'total_devengada', labelKey: 'fm.box.row.total_devengada',  cells: [null, null, 27  ] },
      ],
    },
    iva_deducible: {
