  ...
  sections: {
    ...
    resultado_final: {
      ...
      rows: [
        ...
        { id: 'atribuible_estado',       labelKey: 'fm.box.row.atribuible_estado',        cells: [65, 66], fixedValues: { 65: 100 }, cellTypes: ['percent', 'amount'], cellUnits: ['%', null] },
